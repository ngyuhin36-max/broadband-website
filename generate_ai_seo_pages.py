...
<body>
    ...
    <div class="container">
        ...
        <div class="cta-section">
            ...
            <a href="https://wa.me/85252287541?text={wa_text}" class="cta-btn">WhatsApp 免費諮詢</a>
    ...
    <div class="footer">
        ...
        <p style="margin-top:8px;">WhatsApp: <a href="https://wa.me/85252287541">5228 7541</a></p>
    </div>

    <a href="https://wa.me/85252287541?text={wa_text}" class="wa-float" aria-label="WhatsApp 查詢">
...
<body>
    ...
    <div class="footer">
        <p>&copy; {datetime.now().year} BroadbandHK | <a href="{SITE_URL}/">broadbandhk.com</a> | WhatsApp: <a href="https://wa.me/85252287541">5228 7541</a></p>
    </div>
</body>
</html>"""
    return html
